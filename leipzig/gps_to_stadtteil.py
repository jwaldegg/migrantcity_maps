...
def main():
    geojson_file = 'leipzig/leipzig.geojson'  # specify your file path here
    csv_file = 'leipzig/gps.csv'  # specify your file path here
    csv_output_file = 'leipzig/output_gps.csv'  # specify your file path here
