...
def main():
    geojson_file = 'bremen/bremen.geojson'  # specify your file path here
    csv_file = 'bremen/gps.csv'  # specify your file path here
    csv_output_file = 'bremen/output_gps.csv'  # specify your file path here
